...
uploaded = st.file_uploader("Téléchargez le fichier CSV pré-traité", type="csv", help="Sélectionnez le fichier généré à la fin de la partie II.")
...
for col in selection:
    ...
    if graphique == "Histogramme":
        bins = st.slider(
            f"Nombre de bins pour {col}", min_value=5, max_value=100, value=30,
